...
<head>
    ...
    <meta name="keywords"
          content="tour, tour agency, tour operator, tour package, tourism, travel, travel agency, trip, vacation, holiday, travel booking, tour booking, booking, "/>
    ...
    <!-- Font face -->
    <link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i|Source+Sans+Pro:200,200i,300,300i,400,400i,600,600i,700,700i,900,900i&display=swap"
          rel="stylesheet">
...
<div class="body-inner">
                            ...
                            <ul class="nav-mini-right">
                                <li class="d-none d-sm-block">
                                    <a href="#loginFormTabInModal-register" data-toggle="modal"
                                       data-target="#loginFormTabInModal" data-backdrop="static" data-keyboard="false">
                                        ...
                                        <ul class="main-nav">
                                            ...
                                            <li><a href="result-grid.html">Tour Package</a>
                                                <ul>
                                                    ...
                                                    <li><a href="tour-detail-empty-booking.html">Detail - empty
                                                            booking</a></li>
                                            ...
                                            <li><a href="javascript:void(0)">Blog</a>
                                                <ul>
                                                    ...
                                                    <li><a href="blog-single-02.html">Blog Single - Right Sidebar</a>
                                                    </li>
                                                </ul>
                                            </li>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="shortcode-layout-fullwidth.html">Layout
                                                                    Fullwidth</a></li>
                                                            <li><a href="shortcode-layout-left-sidebar.html">Layout Left
                                                                    Sidebar</a></li>
                                                            <li><a href="shortcode-layout-right-sidebar.html">Layout
                                                                    Right Sidebar</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
    ...
    <div class="main-wrapper scrollspy-container">
        ...
        <div class="hero-banner hero-banner-01 overlay-light opacity-2 overlay-relative overlay-gradient gradient-white alt-option-03"
             style="background-image:url('images/image-bg/01.jpg'); background-position: top center;">
            ...
            <div class="hero-inner">
                ...
                <div class="container">
                    <h1>Go <span class="font200">tour <span class="block">with <span
                                        class="font700">Gi</span>Jalan </span></span></h1>
                                                ...
                                                <div class="col">
                                                    <div class="col-inner">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="chosen-the-basic form-control form-control-sm"
                                                ...
                                                <div class="col">
                                                    <div class="col-inner">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="chosen-the-basic form-control form-control-sm"
                                                                    placeholder="Select two" tabindex="2">
                                                                <option></option>
                                                                <option>All</option>
                                                                <option>Asia</option>
                                                    ...
                                                    <div class="col-inner">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   placeholder="Pick a month" data-min-view="months"
                                                                   data-view="months" data-date-format="MM yyyy"
                                                                   data-language="en" data-auto-close="true" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="slick-carousel-inner">
                        ...
                        <div class="slick-top-destination">
                            ...
                            <div class="slick-item">
                                <figure class="destination-grid-item-01 alt-higher">
                                    <a href="#">
                                        <div class="image">
                            ...
                            <a href="#">
                                ...
                                <figcaption class="content">
                                    ...
                                    <ul class="item-meta">
                                        ...
                                        <li>
                                            <div class="rating-item rating-sm rating-inline clearfix">
                                                ...
                                                <p class="rating-text font600 text-muted font-12 letter-spacing-1">26
                                                    reviews</p>
                                            </div>
                                        </li>
                                    </ul>
                                    <ul class="item-meta mt-15">
                                        ...
                                        <li>
                                            Start: <span class="font600 h6 line-1 mv-0"> Rome</span> - End: <span
                                                    class="font600 h6 line-1 mv-0"> Naoples</span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="item-meta">
                                        ...
                                        <li>
                                            <div class="rating-item rating-sm rating-inline clearfix">
                                                ...
                                                <p class="rating-text font600 text-muted font-12 letter-spacing-1">53
                                                    reviews</p>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <a href="#">
                                ...
                                <figcaption class="content">
                                    ...
                                    <ul class="item-meta">
                                        ...
                                        <li>
                                            <div class="rating-item rating-sm rating-inline clearfix">
                                                ...
                                                <p class="rating-text font600 text-muted font-12 letter-spacing-2">44
                                                    reviews</p>
                                            </div>
                                        </li>
                                    </ul>
                                    <ul class="item-meta mt-15">
                                        ...
                                        <li>
                                            Start: <span class="font600 h6 line-1 mv-0"> Hochiminh</span> - End: <span
                                                    class="font600 h6 line-1 mv-0"> Hanoi</span>
                                        </li>
                                    </ul>
                                    <p class="mt-3">Price from <span
                                                class="h6 line-1 text-primary font16">$125.99</span> <span
                    ...
                    <div class="col">
                        ...
                        <figure class="tour-grid-item-01">
                            ...
                            <a href="#">
                                ...
                                <div class="image">
                                    <img src="images/image-tour/04.jpg" alt="images"/>
                                </div>
                                ...
                                <figcaption class="content">
                                    ...
                                    <ul class="item-meta mt-15">
                                        <li><span class="font700 h6">3 days &amp; 2 night</span></li>
                                        <li>
                                            Start: <span class="font600 h6 line-1 mv-0"> Zagreb</span> - End: <span
                                                    class="font600 h6 line-1 mv-0"> Athens</span>
                                        </li>
                                    </ul>
                                    <p class="mt-3">Price from <span
                                                class="h6 line-1 text-primary font16">$125.99</span> <span
                    ...
                    <div class="col">
                        ...
                        <figure class="tour-grid-item-01">
                            ...
                            <a href="#">
                                ...
                                <div class="image">
                                    <img src="images/image-tour/05.jpg" alt="images"/>
                                </div>
                                ...
                                <figcaption class="content">
                                    ...
                                    <ul class="item-meta mt-15">
                                        ...
                                        <li>
                                            Start: <span class="font600 h6 line-1 mv-0"> Bangkok</span> - End: <span
                                                    class="font600 h6 line-1 mv-0"> Hanoi</span>
                                        </li>
                                    </ul>
                                    <p class="mt-3">Price from <span
                    ...
                    <div class="col">
                        ...
                        <figure class="tour-grid-item-01">
                            ...
                            <a href="#">
                                ...
                                <div class="image">
                                    <img src="images/image-tour/06.jpg" alt="images"/>
                                </div>
                                            ...
                                            <div class="testimonial-grid-01">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="saying">Real sold my in call. Invitation on an advantages
                                                        collecting. But event old above shy bed noisy. Had sister see
                                                        wooded favour income has. Stuff rapid since hence.</p>
                                                ...
                                                <div class="man clearfix">
                                                    ...
                                                    <div class="image">
                                                        <img src="images/image-man/01.jpg" alt="images"
                                                             class="img-circle"/>
                                                    </div>
                                        ...
                                        <div class="slick-item">
                                            ...
                                            <div class="testimonial-grid-01">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="saying">Greatly hearted has who believe. Sir margaret
                                                        drawings repeated recurred exercise laughing may you. Cheerful
                                                        but whatever ladyship disposed yet judgment.</p>
                                                ...
                                                <div class="man clearfix">
                                                    ...
                                                    <div class="image">
                                                        <img src="images/image-man/02.jpg" alt="images"
                                                             class="img-circle"/>
                                                    </div>

                                                    <div class="texting">
                                                        <h5>Christine Gateau</h5>
                                                        <p class="text-muted testimonial-cite">Travel on November
                                                            2016</p>
                                                    </div>
                                        ...
                                        <div class="slick-item">
                                            ...
                                            <div class="testimonial-grid-01">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <p class="saying">Ask especially collecting terminated may son
                                                        expression. Extremely eagerness principle estimable cannot going
                                                        laughing may you about water defer.</p>
                                                ...
                                                <div class="man clearfix">
                                                    ...
                                                    <div class="image">
                                                        <img src="images/image-man/03.jpg" alt="images"
                                                             class="img-circle"/>
                                                    </div>

                                                    <div class="texting">
                                                        <h5>Suttira Ketkaew</h5>
                                                        <p class="text-muted testimonial-cite">Travel on January
                                                            2017</p>
                                                    </div>
                                            ...
                                            <a href="#" class="btn btn-text-inherit btn-interactive"
                                               ...
                                               aria-expanded="false">
                                                <span class="icon-font"><i
                                                            class="oi oi-dollar text-primary mr-5"></i></span> US dollar
                                            </a>
                                            <div class="dropdown-menu" aria-labelledby="dropdownCurrency">
                                                <div class="dropdown-menu-inner">
                                                    <a class="dropdown-item" href="#"><span class="icon-font"><i
                                                                    class="oi oi-dollar text-primary mr-10"></i></span>US
                                                        Dollar</a>
                                                    <a class="dropdown-item" href="#"><span class="icon-font"><i
                                                                    class="oi oi-british-pound text-primary mr-10"></i></span>UK
                                                        Pound</a>
                                                    <a class="dropdown-item" href="#"><span class="icon-font"><i
                                                                    class="oi oi-euro text-primary mr-10"></i></span>EU
                                                        Euro</a>
                                                    <a class="dropdown-item" href="#"><span class="icon-font"><i
                                                                    class="oi oi-yen text-primary mr-10"></i></span>JP
                                                        Yen</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-12 col-auto">
                    ...
                    <div class="col-inner">
                        <ul class="footer-contact-list">
                            <li>
                                <span class="icon-font text-primary inline-block-middle mr-5 font16"><i
                                            class="fa fa-phone"></i></span> <span class="font700 text-black">1 2258 2554 00</span>
                                <span class="text-muted">Mon-Fri | 8.30am-6:30pm</span>
                            </li>
                            <li>
                                <span class="icon-font text-primary inline-block-middle mr-5 font16"><i
                                            class="fa fa-envelope"></i></span> <span class="font700 text-black">support@gmail.com</span>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row gap-50">
                ...
                <div class="col-12 col-lg-5">
                    ...
                    <p class="mt-20">Excited him now natural saw passage offices you minuter. At by asked being court
                        hopes. Farther so friends am to detract. Forbade concern do private be. Offending residence but
                        men engrossed shy.</p>

                    <a href="#" class="text-capitalize font14 h6 line-1 mb-0 font500 mt-30">read more <i
                                class="elegent-icon-arrow_right font18 inline-block-middle"></i></a>
                        ...
                        <div class="row shrink-auto-sm gap-30">
                            ...
                            <div class="col-12 col-auto">
                                ...
                                <div class="col-inner">
                                    ...
                                    <p class="font12">Savings her pleased are several started females met. Short her not
                                        among being any.</p>
    ...
    <div class="bottom-footer">
        ...
        <div class="container">
            ...
            <div class="row shrink-auto-md gap-10 gap-40-lg">
                ...
                <div class="col-auto">
                    <div class="col-inner">
                        <ul class="footer-menu-list-02">
                            <li><a href="#"><?php print t("Cookies"); ?></a></li>
                ...
                <div class="col-shrink">
                    <div class="col-inner">
                        <p class="footer-copy-right"> &#169; 2005 – 2018 <span
                                    class="text-primary">MyCompany Ltd.,</span> All Rights Reserved.</p>
                    </div>
                </div>
